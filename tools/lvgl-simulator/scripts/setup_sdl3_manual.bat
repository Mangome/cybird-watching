...
echo ====================================
echo LVGL Simulator - Manual SDL3 Build
echo ====================================
echo.
...
if %errorlevel% neq 0 (
    ...
    echo   Option 1: Use MSYS2: pacman -S mingw-w64-x86_64-cmake
...
if %errorlevel% neq 0 (
    ...
    echo   Recommended: Use MSYS2 and add C:\msys64\mingw64\bin to PATH
    echo.
    echo See QUICK_START.md for detailed instructions.
    pause
    exit /b 1
...
if not exist "bin\SDL3.dll" (
    ...
    echo [OK] SDL3.dll already in output directory
)
